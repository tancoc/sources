...
export const ignore = ['name', 'position', 'display', 'overflow', 'height', 'width', 'cursor', 'size', 'color', 'radius']
...
export const styles = (props) => css`
	...
	flex-direction: ${!props.item && props.direction && (typeof props.direction === 'object' ? props.direction[0] && props.direction[0] : props.direction)};
	flex-wrap: ${!props.item && props.wrap && (typeof props.wrap === 'object' ? props.wrap[0] && props.wrap[0] : props.wrap)};
	flex-flow: ${!props.item && props.flow && (typeof props.flow === 'object' ? props.flow[0] && props.flow[0] : props.flow)};
	order: ${props.item && props.order && (typeof props.order === 'object' ? props.order[0] && props.order[0] : props.order)};
	flex-grow: ${props.item && props.grow && (typeof props.grow === 'object' ? props.grow[0] && props.grow[0] : props.grow)};
	flex-shrink: ${props.item && props.shrink && (typeof props.shrink === 'object' ? props.shrink[0] && props.shrink[0] : props.shrink)};
	flex-basis: ${props.item && props.basis && (typeof props.basis === 'object' ? props.basis[0] && props.basis[0] : props.basis)};
	flex: ${props.item && props.flex && (typeof props.flex === 'object' ? props.flex[0] && props.flex[0] : props.flex)};
	...
	justify-items: ${!props.item && props.justifyItems && (typeof props.justifyItems === 'object' ? props.justifyItems[0] && props.justifyItems[0] : props.justifyItems)};
	align-items: ${!props.item && props.alignItems && (typeof props.alignItems === 'object' ? props.alignItems[0] && props.alignItems[0] : props.alignItems)};
	place-items: ${!props.item && props.placeItems && (typeof props.placeItems === 'object' ? props.placeItems[0] && props.placeItems[0] : props.placeItems)};
	justify-content: ${!props.item && props.justifyContent && (typeof props.justifyContent === 'object' ? props.justifyContent[0] && props.justifyContent[0] : props.justifyContent)};
	align-content: ${!props.item && props.alignContent && (typeof props.alignContent === 'object' ? props.alignContent[0] && props.alignContent[0] : props.alignContent)};
	place-content: ${!props.item && props.placeContent && (typeof props.placeContent === 'object' ? props.placeContent[0] && props.placeContent[0] : props.placeContent)};
	grid-auto-columns: ${!props.item && props.autoColumns && (typeof props.autoColumns === 'object' ? props.autoColumns[0] && props.autoColumns[0] : props.autoColumns)};
	grid-auto-rows: ${!props.item && props.autoRows && (typeof props.autoRows === 'object' ? props.autoRows[0] && props.autoRows[0] : props.autoRows)};
	grid-auto-flow: ${!props.item && props.autoFlow && (typeof props.autoFlow === 'object' ? props.autoFlow[0] && props.autoFlow[0] : props.autoFlow)};
	...
	justify-self: ${props.item && props.justifySelf && (typeof props.justifySelf === 'object' ? props.justifySelf[0] && props.justifySelf[0] : props.justifySelf)};
	align-self: ${props.item && props.alignSelf && (typeof props.alignSelf === 'object' ? props.alignSelf[0] && props.alignSelf[0] : props.alignSelf)};
	place-self: ${props.item && props.placeSelf && (typeof props.placeSelf === 'object' ? props.placeSelf[0] && props.placeSelf[0] : props.placeSelf)};
	...
	margin: ${props.main ? '0 auto' : props.margin && (typeof props.margin === 'object' ? props.margin[0] && props.margin[0] : props.margin)};
	...
	width: ${props.main ? '100%' : props.width && (typeof props.width === 'object' ? props.width[0] && props.width[0] : props.width)};
	...
	padding: ${props.main ? '0 2.4rem' : props.padding && (typeof props.padding === 'object' ? props.padding[0] && props.padding[0] : props.padding)};
	...
	z-index: ${props.index && props.index};
	...
	${system.breakpoints.map(
		(value, index) => css`
			@media (min-width: ${value}em) {
				...
				flex-direction: ${!props.item && props.direction && typeof props.direction === 'object' && props.direction[index + 1] && props.direction[index + 1]};
				flex-wrap: ${!props.item && props.wrap && typeof props.wrap === 'object' && props.wrap[index + 1] && props.wrap[index + 1]};
				flex-flow: ${!props.item && props.flow && typeof props.flow === 'object' && props.flow[index + 1] && props.flow[index + 1]};
				order: ${props.item && props.order && typeof props.order === 'object' && props.order[index + 1] && props.order[index + 1]};
				flex-grow: ${props.item && props.grow && typeof props.grow === 'object' && props.grow[index + 1] && props.grow[index + 1]};
				flex-shrink: ${props.item && props.shrink && typeof props.shrink === 'object' && props.shrink[index + 1] && props.shrink[index + 1]};
				flex-basis: ${props.item && props.basis && typeof props.basis === 'object' && props.basis[index + 1] && props.basis[index + 1]};
				flex: ${props.item && props.flex && typeof props.flex === 'object' && props.flex[index + 1] && props.flex[index + 1]};

				grid-template-columns: ${!props.item && props.columns && typeof props.columns === 'object' && props.columns[index + 1] && (typeof props.columns[index + 1] === 'number' ? `repeat(${props.columns[index + 1]}, 1fr)` : props.columns[index + 1])};
				grid-template-rows: ${!props.item && props.rows && typeof props.rows === 'object' && props.rows[index + 1] && (typeof props.rows[index + 1] === 'number' ? `repeat(${props.rows[index + 1]}, 1fr)` : props.rows[index + 1])};
				justify-items: ${!props.item && props.justifyItems && typeof props.justifyItems === 'object' && props.justifyItems[index + 1] && props.justifyItems[index + 1]};
				align-items: ${!props.item && props.alignItems && typeof props.alignItems === 'object' && props.alignItems[index + 1] && props.alignItems[index + 1]};
				place-items: ${!props.item && props.placeItems && typeof props.placeItems === 'object' && props.placeItems[index + 1] && props.placeItems[index + 1]};
				justify-content: ${!props.item && props.justifyContent && typeof props.justifyContent === 'object' && props.justifyContent[index + 1] && props.justifyContent[index + 1]};
				align-content: ${!props.item && props.alignContent && typeof props.alignContent === 'object' && props.alignContent[index + 1] && props.alignContent[index + 1]};
				place-content: ${!props.item && props.placeContent && typeof props.placeContent === 'object' && props.placeContent[index + 1] && props.placeContent[index + 1]};
				grid-auto-columns: ${!props.item && props.autoColumns && typeof props.autoColumns === 'object' && props.autoColumns[index + 1] && props.autoColumns[index + 1]};
				grid-auto-rows: ${!props.item && props.autoRows && typeof props.autoRows === 'object' && props.autoRows[index + 1] && props.autoRows[index + 1]};
				grid-auto-flow: ${!props.item && props.autoFlow && typeof props.autoFlow === 'object' && props.autoFlow[index + 1] && props.autoFlow[index + 1]};
				grid-column: ${props.item && props.column && typeof props.column === 'object' && props.column[index + 1] && (typeof props.column[index + 1] === 'number' ? `span ${props.column[index + 1]}` : props.column[index + 1])};
				grid-row: ${props.item && props.row && typeof props.row === 'object' && props.row[index + 1] && (typeof props.row[index + 1] === 'number' ? `span ${props.row[index + 1]}` : props.row[index + 1])};
				justify-self: ${props.item && props.justifySelf && typeof props.justifySelf === 'object' && props.justifySelf[index + 1] && props.justifySelf[index + 1]};
				align-self: ${props.item && props.alignSelf && typeof props.alignSelf === 'object' && props.alignSelf[index + 1] && props.alignSelf[index + 1]};
				place-self: ${props.item && props.placeSelf && typeof props.placeSelf === 'object' && props.placeSelf[index + 1] && props.placeSelf[index + 1]};
				...
				max-width: ${props.main ? `${value}em` : props.maxWidth && typeof props.maxWidth === 'object' && props.maxWidth[index + 1] && props.maxWidth[index + 1]};
